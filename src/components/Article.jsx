export const Article = ({ article, id }) => {
  return (
    <article key={id} className="flex justify-center ml-2 mr-2">
      <div className="relative mb-4">
        ...
        <div className="font-valorantStandard">
          <p className="mt-3 text-2xl">{article.date}</p>
          <h3 className="text-3xl cursor-pointer hover:text-red-500 duration-200 ease-in lg:w-[400px]">
            {article.text}
          </h3>
        </div>
      </div>
